    ...
    <div class="row">
        <div class="col-md-6">
            <div class="img" style="position:relative; z-index:1;">
                <video style="border-radius:50px 50px 50px 50px" controls src="img/Symptoms.mp4" width="600">
...
<div>
    ...
    <div class="row">
        <div class="col-md-7">
            <p style="text-align:center">If you or someone you know is experiencing symptoms that could be related to COVID-19, it's important to seek medical advice, especially if you have underlying health conditions .</p>
        </div>
...
video {
    width: calc(300.33% - 20px); /* Adjust width and gap values */
}
...
<div class="video-container">
    <div class="video-item">
        ...
        <h6>How Corona Virus Is Very Contigous</h6>
    </div>
    ...
    <div class="image-item">
        ...
        <h6>Click The Image For Additional Information About The Covid-19. The Worlds New Center Of Attention </h6>
    </div>
</div>
</div>
</div> 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 footer-section">
                    ...
                    <p>Explore insights into the symptoms, and preventive measures.follow official guidelines, and
                ...
                <div class="col-md-3 footer-section">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li><a href="https://www.facebook.com/LongCovidPage/"><i class="fab fa-facebook"></i> Facebook</a></li>
                        <li><a href="https://www.instagram.com/preventcovid19/?hl=en"><i class="fab fa-instagram"></i> Instagram</a></li>
                                <li><a href="https://www.longcovid.org/"><i class="fab fa-google"></i>Google</a></li>
                            </ul>
                        </div>
                    </ul>
                </div>
